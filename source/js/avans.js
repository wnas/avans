...
var myCarousel = (function() {
  ...
  function init(set) {
	...
	settings.id = "slider";
	settings.slidenav = true;
	settings.animate = true;
	settings.annnounceItem = true;
    ...
    ctrls.innerHTML = '<li>' +
        '<button type="button" class="btn-prev">Vorig</button>' +
      '</li>' +
      '<li>' +
        '<button type="button" class="btn-next">Volgend</button>' +
      '</li>';
...
console.log('test ',typeof announceItemHere);
...
//    announceItem = typeof announceItemHere !== 'undefined' ? announceItemHere : false;
    ...
    slides[new_next].setAttribute('', 'true');
